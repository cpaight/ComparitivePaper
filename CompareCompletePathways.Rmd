...
pMrubrumMap <- read.delim("~/Documents/ComparitivePaperWork/CompletePathways/matrix/pMrubrumMap.txt", stringsAsFactors=FALSE)
MpulexMap <- read.delim("~/Documents/ComparitivePaperWork/CompletePathways/matrix/MpulexMap.txt", stringsAsFactors=FALSE)
MchameleonMap <- read.delim("~/Documents/ComparitivePaperWork/CompletePathways/matrix/MchameleonMap.txt", stringsAsFactors=FALSE)
tMrubrumMap <- read.delim("~/Documents/ComparitivePaperWork/CompletePathways/matrix/tMrubrumMap.txt", stringsAsFactors=FALSE)
KeggTable <- read.delim2("~/Documents/ComparitivePaperWork/CompletePathways/matrix/KeggTable.txt", stringsAsFactors=FALSE)
```
...
sparch <- ggplot(PathwaySummary4graphOrder, aes(x=species, y=count, group=Catagory))+geom_line()+geom_point()+ theme_bw()+ theme(axis.text.x = element_text(angle = 45, hjust=1))
plot(sparch)
```
